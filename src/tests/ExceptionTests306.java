...
public class ExceptionTests306 {
	...
	public void testBadColumns() throws BadConfigFormatException, FileNotFoundException {
		assertThrows(BadConfigFormatException.class, () -> {
			...
			board.setConfigFiles("/Users/wjwarner24/desktop/Clue2/src/data/ClueLayoutBadColumns306.csv", "/Users/wjwarner24/desktop/Clue2/src/data/ClueSetup306.txt");
	...
	public void testBadRoom() throws BadConfigFormatException, FileNotFoundException {
		assertThrows(BadConfigFormatException.class, () -> {
			Board board = Board.getInstance();
			board.setConfigFiles("/Users/wjwarner24/desktop/Clue2/src/data/ClueLayoutBadRoom306.csv", "/Users/wjwarner24/desktop/Clue2/src/data/ClueSetup306.txt");
			board.loadSetupConfig();
			board.loadLayoutConfig();
		});
	}
	...
	public void testBadRoomFormat() throws BadConfigFormatException, FileNotFoundException {
		assertThrows(BadConfigFormatException.class, () -> {
			Board board = Board.getInstance();
			board.setConfigFiles("/Users/wjwarner24/desktop/Clue2/src/data/ClueLayout306.csv", "/Users/wjwarner24/desktop/Clue2/src/data/ClueSetupBadFormat306.txt");
			board.loadSetupConfig();
			board.loadLayoutConfig();
		});
	}
